...
class TeamDinner:
    ...
    # 회식하기 페이지 이동
    def go_team_dinner(self):
        WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="root"]/div[1]/main/section/div/div[1]/button[3]'))).click()
    ...
    # 다시 추천 받기
    def RE_choice(self):
        self.driver.find_element(By.XPATH,'//*[@id="root"]/div[1]/main/section/section/button[1]').click()
