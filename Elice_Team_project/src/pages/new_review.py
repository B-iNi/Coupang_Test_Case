...
class NewReview:
    ...
    #리뷰 사진 등록
    def add_image(self, image_filename="cat.png"):

        file_input = self.wait.until(
            EC.presence_of_element_located((By.CSS_SELECTOR, "input[type='file']"))
        )

        image_path = r"C:\Users\zz910\OneDrive\Desktop\cat.png"
    ...
    def add_menuname(self):
        ...
        # 100~999 사이의 난수를 생성하여 메뉴 이름에 추가
        menu_name_with_random = f"테스트용 음식 {random.randint(100, 999)}"
