...
class SignupPage:
    ...
    def like_dislike(self):
        faker=Faker()
        # 좋아요/싫어요 항목 입력 (100자 이상)
        like_input = self.driver.find_element(By.NAME, "pros")
        dislike_input = self.driver.find_element(By.NAME, "cons")
        like_input.send_keys(faker.text(max_nb_chars=100))
        dislike_input.send_keys(faker.text(max_nb_chars=100))
